...
export const HamburgerMenu: FC = () => {
  ...
  return (
    <>
      <div
        className={`fixed h-screen w-full duration-0 ${isOpen ? "z-50 delay-0" : "-z-50 delay-[600ms]"}`}
      >
        <div
      ...
      <div
        className={`fixed right-0 z-50 transition-[background-color] duration-300 ${isOpen ? "bg-white./85 h-screen w-full" : "bg-white./.0 h-0 w-0"}`}
      >
        <button
        ...
        <div
          className={`absolute flex h-screen w-48 flex-col justify-between bg-theme pb-12 pt-[4.5rem] duration-300 md:w-72 md:pt-8 ${isOpen ? "right-0" : "-right-48 md:-right-72"}`}
        >
