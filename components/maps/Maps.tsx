...
const mapSvgAll = [
  ...
  >
    ...
    <g id="ground1" className={boxFS}>
      ...
      <path
        d="M77.22 22.38h76a16 16 0 010 32h-76.02a16 16 0 010-32z"
        id="minitrain"
      />
    ...
    <path
      className={boxFS}
      d="M62.56 444.13h33.97v71.02h-33.97zM1.4 444.13h48.44v81.29h-48.44z"
      id="meeting"
    />
    <path
      className={boxFS}
      d="M164.35 137.27h-83.77v42.82h83.77l4.05-14.28v-14.26l-4.05-14.28z"
      id="music"
    />
    <path
      className={boxFS}
      d="M260.99 180.12h32.01v21.91h-32.01z"
      id="newgarden"
    />
    <path
      className={boxFS}
    ...
    <path
      className={boxFS}
      d="M59.33 762.25h163.03v50.94h-163.03z"
      id="tennis"
    />
    <g>
      <g>
        ...
        <path
          fill="#fff"
          opacity=".9"
          d="M292.88 373.34a1.34 1.34 0 010 2.68 1.34 1.34 0 010-2.68zM295.859 382.931h-3.549v-5.411h1.18v4.2h3.5l.53 3.75 1.62-.24-.13-.88-.73.11-.51-3.63h-3.38v-4.2h-2.98v1.78a4.083 4.083 0 001.64 7.82c1.251.008 2.34-.63 3.06-1.55z"
        />
      </g>
      <g>
        <path
      ...
      <g>
        <path
          fill="#4f8e3a"
          stroke="none"
          d="M49.83 581.42h23.35v23.74h-23.35z"
        />
        <g fill="#fff" opacity=".9">
      ...
      <g>
        <path
          fill="#e50020"
          stroke="none"
          d="M73.18 581.42h23.35v23.74h-23.35z"
        />
        <g fill="#fff" opacity=".9">
    ...
    <g>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={33} lengthAdjust={"spacing"}>
          ジュース
        </tspan>
      </text>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={63} lengthAdjust={"spacing"}>
          スロープ２階へ
        </tspan>
      </text>
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={43} lengthAdjust={"spacing"}>
          お土産販売
        </tspan>
      </text>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="-2" textLength={34} lengthAdjust={"spacing"}>
          図書委員会
        </tspan>
      </text>
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={66} lengthAdjust={"spacing"}>
          食堂地下１階へ
        </tspan>
      </text>
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={68} lengthAdjust={"spacing"}>
          鉄道研究部
        </tspan>
      </text>
      <text
  ...
  >
    <path
      className={boxFS}
      d="M.51 296.81h42.56v119.65h-42.56z"
      id="audiovisual"
    />
    ...
    <path
      className={boxF_}
      d="M55.36 187.38h15.47v30.72h-15.47 z"
      id="kingcrab"
    />
    ...
    <g id="m1-4" className={boxF_}>
      <path
        d="M 100.9 187.46h19.52v30.64h-19.52v-30.64 z"
        id="studentcouncil"
      />
    ...
    <g>
      <g>
        <path
          fill="#004d85"
          stroke="none"
          d="M81.35 247.75h20.75v15.32H81.35z"
        />
        <g fill="#fff" opacity=".9">
    ...
    <g>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={110} lengthAdjust={"spacing"}>
          視聴覚ステージ
        </tspan>
      </text>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={30} lengthAdjust={"spacing"}>
          タラバガニ
        </tspan>
      </text>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={29} lengthAdjust={"spacing"}>
          生徒会の間
        </tspan>
      </text>
      <text
  ...
  >
    <path
      className={boxF_}
      d="M 319.487 295.98h74.723v35.67h-74.723v-35.67"
      id="biology"
    />
    <path
      className={boxF_}
      d="M 326.09 253.67h49.397v36.84h-49.397v-36.84 z"
      id="biologysub"
    />
    <path
      className={boxF_}
    ...
    <path
      className={boxFS}
      d="M 2.54 179.79h53.9v39.82h-53.9 z"
      id="english2"
    />
    <path
      className={boxFS}
      d="M 247.25 61.66h57.12v-48.86h-57.12 z"
      id="h2-1"
    />
    ...
    <path
      className={boxF_}
      d="M 319.487 331.65h74.723v35.67h-74.723v-35.67"
      id="kendo"
    />
    <g id="h2-2" className={boxF_}>
    ...
    <path
      className={boxFS}
      d="M 56.44 179.79v39.82h50.74v-39.82h-50.74 z"
      id="m2-4"
    />
    ...
    <g id="socialstudies2" className={boxF_}>
      ...
      <path
        d="M 326.09 235.2h49.397v18.47h-49.397v-18.47 z"
        id="urbandevelopment"
      />
    </g>
    <g>
      <g>
        <path
          fill="#e50020"
          className={boxStroke}
          d="M 271.2 258.13h26.89v19.91h-26.89 z"
        />
        <g fill="#fff" opacity=".9">
      ...
      <g>
        ...
        <g fill="#fff" opacity=".9">
          ...
          <path d="M287.63 251.77h-4.29v-6.35h1.39v4.92h4.11v.08l.62 4.33 1.9-.29-.16-1.04-.85.13-.6-4.26h-3.96v-4.92h-3.5v2.09a4.79 4.79 0 0 0-2.87 4.38c0 2.64 2.15 4.79 4.79 4.79h.11c1.46-.04 2.75-.74 3.59-1.81l-.29-2.04Zm-4.29.01h.01-.01Z" />
        </g>
      </g>
      <g>
        <path
          fill="#004d85"
          className={boxStroke}
          d="M 55.31 12.8h20.87v48.9h-20.87 z"
        />
        <g fill="#fff" opacity=".9">
    ...
    <g>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="-20" textLength={75} lengthAdjust={"spacing"}>
          化学研究部
        </tspan>
      </text>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="-5" textLength={45} lengthAdjust={"spacing"}>
          ポケモン
        </tspan>
        <tspan x="-8.63" y="-5" textLength={45} lengthAdjust={"spacing"}>
          サークル
        </tspan>
      </text>
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="-.5" textLength={48} lengthAdjust={"spacing"}>
          文化祭からの
        </tspan>
        <tspan x="-12" y="14" textLength={20} lengthAdjust={"spacing"}>
          脱出
        </tspan>
      </text>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="-6" textLength={35} lengthAdjust={"spacing"}>
          パズル
        </tspan>
      </text>
      <text
        ...
        writingMode="tb"
      >
        <tspan x="0" y="0" textLength={39} lengthAdjust={"spacing"}>
          ドラえもん
        </tspan>
        <tspan x="-8.63" y="2" textLength={35} lengthAdjust={"spacing"}>
          同好会
        </tspan>
      </text>
    </g>
  ...
  >
    <path
      className={boxFS}
      d="M268.96 221.07h53.72v56.03h-53.72z"
      id="earthscience"
    />
    <path
      className={boxFS}
      d="M292.12 17.25h-46.58v47.9h55.89v-47.9z"
      id="h1-1"
    />
    <path
      className={boxFS}
      d="M236.15 17.25h-46.58v47.9h55.9v-47.9z"
      id="h1-2"
    />
    <path
      className={boxFS}
      d="M180.33 17.25h-46.58v47.9h55.9v-47.9z"
      id="h1-3"
    />
    ...
    <path
      className={boxFS}
      d="M129.99 180.83h-24.85v39.02h49.71v-39.02z"
      id="m3-2"
    />
    <path
      className={boxF_}
      d="M 55.46 180.751h49.74v38.814h-49.74v-38.814 z"
      id="m3-3"
    />
    <path
      className={boxF_}
      d="M 5.72 180.751h49.74v38.814h-49.74v-38.814 z"
      id="m3-4"
    />
    <path
      className={box__}
      d="M 5.72 180.751h74.76v38.814h-74.76v-38.814 z"
      id="amateurradio"
    />
    <path
      className={box__}
      d="M 80.48 180.751h24.72v38.814h-24.72v-38.814 z"
      id="conan"
    />
    <path
      className={boxF_}
      d="M204.41 180.83h41.13v38.814h-41.13v-38.814z"
      id="m3open"
    />
    <path
      className={boxFS}
      d="M 340.3 59.89h49.61v35.08h-49.61 z"
      id="multipurpose"
    />
    <path
      className={boxFS}
      d="M 322.71 94.97h67.2v69.97h-67.2 z"
      id="physics"
    />
    <g>
      <g>
        <path
          ...
          stroke="#231815"
          className={boxStroke}
          d="M 57.42 17.25h20.44v23.95h-20.44 z"
        />
        <path
          fill="#fff"
          stroke="none"
      ...
      <g>
        <path
          ...
          stroke="#231815"
          className={boxStroke}
          d="M31.36 238.08h30.93v19.88H31.36z"
        />
        <path
          fill="#fff"
          stroke="none"
          opacity=".9"
          d="M 46.62 240.04 a 1.34 1.34 0 0 1 0 2.68 a 1.34 1.34 0 0 1 0 -2.68 zM 50.04 250.83h-4.08v-6.21h1.35 l 0.01 4.8h4 l 0.61 4.3 l 1.85 -0.28 l -0.15 -1.01 l -0.83 0.13 l -0.58 -4.16h-3.87 l -0.01 -4.8h-3.4v2.04 a 4.67 4.67 0 0 0 1.87 8.95 c 1.425 -0.014 2.68 -0.73 3.51 -1.77 l -0.28 -1.99 z"
        />
      </g>
      <g>
        <path
          ...
          stroke="#231815"
          className={boxStroke}
          d="M 31.36 257.25h30.93v19.88h-30.93v-19.88 z"
        />
        <path
          fill="#fff"
          stroke="none"
          opacity=".9"
          d="M 47.08 259.89 a 1.34 1.34 0 0 1 0 2.68 a 1.34 1.34 0 0 1 0 -2.68zM 45.2793 263.4902 c -0.43 0 -0.7793 0.3493 -0.7793 0.7793v5.5899 c 0 0.22 0.1806 0.3906 0.3906 0.3906h0.8398v4 c 0 0.144 0.1157 0.2598 0.2598 0.2598h2.1699 c 0.144 0 0.2598 -0.1157 0.2598 -0.2598v-4h0.8496 c 0.22 0 0.3906 -0.1806 0.3906 -0.3906v-5.5899 c 0 -0.43 -0.3493 -0.7793 -0.7793 -0.7793h-3.6016 z"
        />
      </g>
      <g>
        <path
          ...
          stroke="#231815"
          className={boxStroke}
          d="M 57.42 41.2h20.44v23.95h-20.44 z"
        />
        <path
          fill="#fff"
          stroke="none"
          opacity=".9"
          d="M 66.81 45.56 a 1.34 1.34 0 0 1 0 2.68 a 1.34 1.34 0 0 1 0 -2.68 zM 70.23 56.35h-4.08v-6.21h1.35 l 0.01 4.8h4 l 0.61 4.3 l 1.85 -0.28 l -0.15 -1.01 l -0.83 0.13 l -0.58 -4.16h-3.87 l -0.01 -4.8h-3.4v2.04 a 4.67 4.67 0 0 0 1.87 8.95 c 1.425 -0.014 2.68 -0.73 3.51 -1.77 l -0.28 -1.99 z"
        />
      </g>
    </g>
    <path
      className={box_S}
      d="M 154.7 180.83h49.71v39.02h-49.71 zM 268.94 196.35h53.77v80.75h-53.77 z m -210.55 -179.1h-21.1v66.02h105.89 m 98.65 193.83h27.11 m -13.58 -8.5v-23.09 m -236.82 -1.83v25.74 m 308.12 -245.57h32 m -311.81 4.71v29.06 m 157.56 123.23h90.87v-97.58h-152.1 m -84.68 193.83h-52.78v-57.25 m 316.99 -23.5v-31.41h57.34 m -78.62 -99.77v-56.85h64.09v30.67h-42.81v40.97 m 0 -20.07h17.58 m -284.862 120.987v38.973 m 49.772 -39.083h-99.48v39.083h99.48v-39.083 z m -42.91 57.313h179.54v39.02h-179.54 z"
    />
    <path
      className={box_SD}
      d="M 245.54 180.83v38.814h-41.13M80.48 180.853v38.997"
    />
    <path
      className={box_ST}
      d="M 46.85 28.9h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 m -10.57 2.66h10.57 M 241.83 245.84h13.53 m -13.53 2.66h13.53 m -13.53 2.66h13.53 m -13.53 2.66h13.53 m -13.53 2.66h13.53 m -13.53 2.66h13.53 m -13.53 2.66h13.53 m -13.53 2.66h13.53 M 18.54 243.95h12.82 m -12.82 2.66h12.82 m -12.82 2.66h12.82 m -12.82 2.66h12.82 m -12.82 2.66h12.82 m -12.82 2.66h12.82 m -12.82 2.66h12.82 m -12.82 2.66h12.82 m -12.82 2.66h12.82 M 326.99 23.85v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.66 -15.15v15.15 m 2.56 -15.15v15.15"
    />
    <g>
      <text
        ...
        fontSize="13px"
      >
        <tspan x="0" y="0" textLength={65} lengthAdjust={"spacing"}>
          物理研究部
        </tspan>
      </text>
      ...
      <text
        ...
        writingMode="tb"
      >
        <tspan x="1" y="6" textLength={30} lengthAdjust={"spacing"}>
          コナン
        </tspan>
        <tspan x="-8" y="1" textLength={38} lengthAdjust={"spacing"}>
          サークル
        </tspan>
      </text>
