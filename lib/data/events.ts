...
export const events: Event[] = [
...

  {
    ...
    name: "オセロ対抗戦 灘vs京大",
    description:
      "昨年に続き2度目の開催となる京大対抗戦！日本トップレベルの実力をもつ京大オセロサークルKIJINに灘オセロサークルNSOCは勝つことができるのか…⁉︎",
    category: "lecture_m",
    mapId: "m3-2",
  },
  {
  ...
  },
  {
    ...
    name: "ロボットプログラミング講習",
    description:
      "中学棟3-3教室でロボットプログラミング講習を行います。 黒い線の上を走るライントレースロボットのプログラミングをしてもらいます。 実際にコースも用意していますので、プログラミングを終えたら動かすことができます。",
    category: "raffle",
    mapId: "m3-3",
  },
  {
