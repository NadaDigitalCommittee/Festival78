...
export const data: Circle[] = [
  ...
  },
  {
    id: "souvenir",
    name: "お土産",
    description: "共栄館前でお土産を販売します！定番の瓦煎餅や三笠、紅茶に加え、新商品『ショウタニほろほろクッキー』を倉橋先生の篆書缶でご提供。『桂新堂灘校えびせんべい』はオリジナル必勝桜箱で。『灘ミント』は手のひらサイズのスライド缶入りミントタブレットです。ぜひお立ち寄りくださいませ♪",
    place: "Kyoei",
    mapId: "souvenir",
    urls: [],
  },
  {
    id: "goods",
    name: "灘校グッズ",
    description: "灘校の校章をあしらったグッズや、文化祭ロゴデザインの生徒会企画品を販売しています。定番文房具から愛らしいぬいぐるみなど、幅広い品揃えで皆さまをお待ちしています。灘校文化祭の記念に、お気に入りを見つけてください。",
    place: "Gym",
    mapId: "gym",
    urls: [],
  },
