...
export const eventsTimetable: EventTimetable[] = [
  //講義用教室
  {
    ...
    time: [{ day: 1, time: new Time(12, 0, 13, 0) }],
  },
  {
  ...
  },
  {
    ...
    time: [{ day: 2, time: new Time(11, 0, 12, 0) }],
  },
  {
    id: "mathematics_event5",
    time: [{ day: 2, time: new Time(14, 0, 15, 0) }],
  },
  {
    id: "othello_event",
    time: [
  ...
  //抽選券企画
  {
    ...
    time: [
      ...
      { day: 2, time: new Time(13, 30, 13, 50) },
    ],
  },
  {
    id: "campustour",
  ...
  {
    id: "muscle",
    time: [{ day: 1, time: new Time(12, 15, 13, 0) }],
  },
  {
    id: "performance",
    time: [
  ...
  {
    id: "finale",
    time: [{ day: 2, time: new Time(14, 15, 15, 15) }],
  },
  {
    id: "n1",
    time: [
  ...
  {
    id: "kakuzuke",
    time: [{ day: 1, time: new Time(9, 30, 10, 30) }],
  },
  {
    id: "quiz",
    time: [{ day: 2, time: new Time(10, 30, 11, 30) }],
  },
  {
    id: "n1consolation",
    time: [{ day: 1, time: new Time(12, 45, 13, 30) }],
  },
  {
    id: "maetoato",
    time: [
