...
const zen_kaku_gothic_new = Zen_Kaku_Gothic_New({ subsets: ["latin"], weight: "400", variable: "--font-zen-kaku-gothic-new" })
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${[inter, limelight, zen_kaku_gothic_new, alte_din_1451_mittelschrift,south_amsterdam_demo,times_new_roman]
